...
ax.set_title("Private HSWE-BLS tally", color="black", fontsize=13)
ax.set_xlabel("# Ciphertexts", color="black")
...
ax.set_title("Privacy-wrapper cost breakdown", color="black", fontsize=13)
ax.set_xlabel("# Ciphertexts", color="black")
ax.set_ylabel("Time (ms)", color="black")
